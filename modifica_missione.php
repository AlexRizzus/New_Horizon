...
if(isset($_SESSION['livello'])){
    if($_SESSION['livello'] == "amministratore"){
        ...
        if (isset($_POST['updateMission']))
        {
            ...
            $stringa='<fieldset class="scrittemodificamissione"><legend class="scrittemodificamissione">Missione:</legend>Nome: <input class="buttoninputmodificamissione" tabindex="1" type="text" name="nome" value="'. $missioni[0]['nome'] .'"></nome><br>
            Data inizio: <input class="buttoninputmodificamissione" tabindex="2" type="text" name="data_inizio" value="'. $missioni[0]['data_inizio'] .'"></Data inizio><br>
            Data di fine: <input class="buttoninputmodificamissione" tabindex="3" type="text" name="data_fine" value="'. $missioni[0]['data_fine'] .'"></Data di fine><br>
            Stato: <input class="buttoninputmodificamissione" tabindex="4" type="text" name="stato" value="'. $missioni[0]['stato'] .'"></Stato><br>
            Affiliazioni: <input class="buttoninputmodificamissione" tabindex="5" type="text" name="affiliazioni" value="'. $missioni[0]['affiliazioni'] .'"></Affiliazioni><br>
            Luogo: <input class="buttoninputmodificamissione" tabindex="6" type="text" name="destinazione" value="'. $missioni[0]['destinazione'] .'"></Luogo><br>
            Scopo: <input class="buttoninputmodificamissione" tabindex="7" type="text" name="scopo" value="'. $missioni[0]['scopo'] .'"></Scopo></fieldset><br><br><input type="hidden" value="'.$missione.'" name="key"><button class="buttonmodificamissione" tabindex="8" type="submit" value="Invia" name="change">Invia</button>';
